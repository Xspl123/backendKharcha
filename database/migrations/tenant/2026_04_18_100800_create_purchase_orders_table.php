...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('purchase_orders', function (Blueprint $table) {
            ...
            $table->enum('status', ['pending', 'approved', 'received', 'cancelled', 'return'])->default('pending');
            $table->boolean('is_return')->default(false);
            $table->unsignedBigInteger('original_po_id')->nullable();
            ...
            $table->index(['org_id', 'status', 'po_date'], 'purchase_orders_org_status_date_index');
        });
    }
